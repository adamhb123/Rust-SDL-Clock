...
fn main() {
    ...
    loop {
        ...
        let seconds_line = shapes::Line::new(
            Point::new(circle.center.x, circle.center.y),
            Point::new(
                (circle.center.x as f64 + second_vector.0) as i32,
                (circle.center.y as f64 + second_vector.1) as i32,
            ),
        );
        let minutes_line = shapes::Line::new(
            Point::new(circle.center.x, circle.center.y),
            Point::new(
                (circle.center.x as f64 + minute_vector.0) as i32,
                (circle.center.y as f64 + minute_vector.1) as i32,
            ),
        );
        let hour_line = shapes::Line::new(
            Point::new(circle.center.x, circle.center.y),
            Point::new(
                (circle.center.x as f64 + hour_vector.0) as i32,
                (circle.center.y as f64 + hour_vector.1) as i32,
            ),
        );
